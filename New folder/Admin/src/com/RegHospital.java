...
public class RegHospital {
	...
	@GET
	@Path("/DoctorDeatails/{A_AppointmentID}")
	@Produces(MediaType.TEXT_HTML)
	public String readAppointments(@PathParam("A_AppointmentID") String A_AppointmentID)
	 {
	 return adminobj.readAppointments(A_AppointmentID);
	 }
